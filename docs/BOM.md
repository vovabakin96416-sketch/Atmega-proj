...
| F1                              |      1 | 12 A; `0451012.MRL`                   | Littelfuse; NANO2 451            | `Fuse_Littelfuse-NANO2-451_453`                  | ORDER_SAMPLE             |
| Q1 Q3                           |      2 | P-MOS 40 V; `DMP4015SSS-13`           | Diodes; SO-8                     | `SOIC-8_3.9x4.9mm_P1.27mm`                       | ORDER_SAMPLE             |
...
| D3 D4                           |      2 | low-leakage 3 A 40 V; `RB058LAM-40TR` | ROHM; SOD-128                    | `D_SOD-128`                                      | BLOCKED_PAD_MAPPING      |
| U1                              |      1 | 3.3 V/2 A buck; `AP63203WU-7`         | Diodes; TSOT-26                  | `TSOT-23-6`                                      | ORDER_SAMPLE             |
| C3 C18                          |      2 | 10 uF 50 V X7R; `GRM32ER71H106KA12L`  | Murata; 1210                     | `C_1210_3225Metric`                              | BLOCKED_DC_BIAS          |
...
| R2 R3 R4 R5 R10 R11 R12 R14 R21 |      9 | 10 kOhm 1%; `RC0603FR-0710KL`         | Yageo; 0603                      | `R_0603_1608Metric`                              | ORDER_SAMPLE             |
...
| R20                             |      1 | 470 Ohm 1%; `RC0805FR-07470RL`        | Yageo; 0805                      | `R_0805_2012Metric`                              | ORDER_SAMPLE             |
...
| D8                              |      1 | green LED; `LTST-C190KGKT`            | Lite-On; 0603                    | `LED_0603_1608Metric`                            | BLOCKED_PAD_MAPPING      |
| R17                             |      1 | 1 kOhm 1%; `RC0603FR-071KL`           | Yageo; 0603                      | `R_0603_1608Metric`                              | ORDER_SAMPLE             |

## Закупочное решение

Можно заказать по 3–10 штук позиций `ORDER_SAMPLE`, включая F1 и оба Q1/Q3, а
также по несколько U2 и L1 для макетирования, понимая, что их PCB footprints ещё
заблокированы. Нельзя размещать полный заказ на C3/C18, C5/C6 или заказывать
собранные платы до закрытия соответствующих `BLOCKED_*`. Замена любого
полупроводника требует нового ревью даташита и физической нумерации.
