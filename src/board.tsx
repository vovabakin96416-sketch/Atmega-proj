  ...
  return (
    <board width="80mm" height="55mm" routingDisabled>
      <group name="PowerInputBlock" schX={-27} schY={10}>
        ...
        <schematictext
          {...at(-8, 3.5)}
          text="Fuse, reverse-polarity MOSFET and TVS; F1 provisional."
          fontSize={0.65}
          anchor="left"
        />
      ...
      <group name="Power5VBlock" schX={-5} schY={10}>
        ...
        <schematictext
          {...at(-3.5, 3.5)}
          text="AHCT buffer supply; USB diode OR-ing."
          fontSize={0.65}
          anchor="left"
        />
      ...
      <group name="UsbBlock" schX={-12.5} schY={1}>
        ...
        <schematictext
          {...at(-8, 3.5)}
          text="USB4105 suffix and footprint remain open before PCB release."
          fontSize={0.65}
          anchor="left"
        />
